######PURE UTIL FUNCTIONS FOR APP HANDLERS######
import os 
import sys
import socket
import copy
from scapy.all import IP, TCP, ICMP, srloop, sr1, srp1

#Currnt_Host
def return_Curr_host():
...
def Echo_Ping(Host_Address):
    ...
    Result = srloop(Packet, count=1, timeout=0.01, verbose=False)[0]
